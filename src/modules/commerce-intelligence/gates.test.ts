...
test("creator solo production gate uses recordsAlone and declared equipment", () => {
  ...
  const complex = { ...brief("solo-1"), development: ["Câmera orbita 360 graus ao redor da pessoa", "Montagem rápida: jogo, música e close", "Animação de ondas sonoras saindo do fone"], script: "A câmera gira 360 graus ao redor de mim enquanto o som passa de lado a lado.", cta: "Saiba mais." };
  ...
  const droneBrief = { ...brief("solo-drone"), development: ["Grave uma tomada com drone"], script: "O drone acompanha o produto." };
  ...
  const solo = validateBriefSet([{ ...brief("solo-2"), development: ["Destaque Fone Space S1", "Reforce drivers de 40 mm"], script: "Esse fone é o Fone Space S1 e tem drivers de 40 mm.", cta: "Se você curte esse tipo de imersão, vale dar uma olhada nesse aqui." }], ev, "tiktok-commerce", "tiktok-commerce@1.2", [], soloContext)[0];
