...
export type JobEventFields = {
  ...
  providerStatus?: number; rootShape?: string; responseKeys?: string[]; arrayLength?: number;
...
const EVENT_ALLOWLIST: Record<JobEventName, (keyof JobEventFields)[]> = {
  ...
  "capability.failed": [...BASE_ALLOWLIST, "durationMs", "timeoutMs", "providerStatus", "expected", "received", "retry", "item", "issue", "errorKind", "rate"],
