...
const brief = { contentId: "c", briefVersionId: "b", version: 1 as const, angle: "a", hook: "h", development: ["Carga de 5 kg demonstrada"], script: "testado com 5 kg de carga", scenes: ["1", "2"], cta: "c" };
