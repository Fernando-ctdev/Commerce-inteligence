...
// rulings); valores zero/nulo preservados. Nomes de origem (snake_case) vivem só aqui —
...
export const PUBLISHED_VIDEO_ANALYTICS_PAGES: PublishedVideoAnalyticsPageFixture[] = [
    {
      ...
      items: [
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 172, ctr: "0.0395", completionRate: "0.0640" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 1, vvCnt: 99, ctr: "0.0381", completionRate: "0.0606" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 88, ctr: "0.0000", completionRate: "0.0114" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 105, ctr: "0.0265", completionRate: "0.0571" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 106, ctr: "0.0093", completionRate: "0.0094" },
      }
      ],
    }
,
    {
      ...
      items: [
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 116, ctr: "0.0000", completionRate: "0.0172" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 148, ctr: "0.0392", completionRate: "0.0541" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 113, ctr: "0.0000", completionRate: "0.0354" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 141, ctr: "0.0000", completionRate: "0.0426" },
      },
      {
        ...
        business: { gmv: "R$ 0,00", directGmv: "R$ 0,00", itemSoldCnt: 0 },
        metrics: { newFollowerCnt: 0, vvCnt: 51, ctr: "0.0000", completionRate: "0.0784" },
      }
      ],
    }
,
